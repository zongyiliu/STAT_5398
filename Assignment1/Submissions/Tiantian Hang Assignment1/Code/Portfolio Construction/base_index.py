...
def main():
    ...
    # Set parameters based on backtesting requirements
    # Portfolio data ranges from 2018-03-01 to 2025-09-01
    # Stock data ranges from 1996-03-01 to 2025-09-01  
    # Download with buffer for backtesting: 1995-01-01 to 2025-12-31
    start_date = "1995-01-01"
    end_date = "2025-12-31"
    output_dir = "./"  # Output to Test directory for backtesting
    ...
    print("Data range based on backtesting requirements:")
    print("  Portfolio rebalancing: 2018-03-01 to 2025-09-01") 
    print("  Stock data available: 1996-03-01 to 2025-09-01")
    print("  Benchmark download: 1995-01-01 to 2025-12-31 (with buffer)")
    print()
    
    # Download all indices
    spx_data, qqq_data = download_all_indices(start_date, end_date, output_dir=output_dir)
