...
def run_stock_selection(data_path, output_path):
    ...
    for sector in sectors:
        ...
        # Change to stock_selection directory to run the script
        script_dir = os.path.dirname(os.path.abspath(__file__))
        fundamental_abs = os.path.abspath(FUNDAMENTAL_FILE)
        sector_abs = os.path.abspath(sector_file)
        ...
        try:
            ...
            print(f" sector{sector} model training timed out")
            continue
        except Exception as e:
            print(f" sector{sector} model training error: {e}")
            continue
        
        # Read prediction results
        script_dir = os.path.dirname(os.path.abspath(__file__))
        result_file = os.path.join(script_dir, f"results/sector{sector}/df_predict_best.csv")
